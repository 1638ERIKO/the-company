    ...
    <div class="col-4">
      ...
      <form action="../actions/edit-user-action.php" method="post" enctype="multipart/form-data">
        ...
        <div class="mb-4">
          ...
          <input type="text" name="username" id="username" class="form-control" maxlength="15" value="<?=$g_user['last_name']?>" required>
        </div>
        <div class="text-end">
          <a href="dashboard.php" class="btn btn-sevondary btn-sm">Cancel</a>
